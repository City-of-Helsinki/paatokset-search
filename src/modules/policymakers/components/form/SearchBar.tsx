...
const SearchBar = React.forwardRef<Component<DataSearchProps, any, any>, {value: string, setValue: any, triggerSearch: any}>((props, ref) => {
  const { value, setValue, triggerSearch } = props;
